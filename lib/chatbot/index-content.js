...
At FekiTech, we combine custom software, intelligent automation, and expert technology consultancy to help you run a more profitable business with less stress.
Fekitech transforms businesses through business audits, gap diagnosis, transformation roadmaps, smart business systems, performance scaling, and long-term strategic support.`
    },
    {
      ...
      slug: "/about",
      text: `FekiTech is a technology company specialising in software development, IT consultancy, and business systems design for small and growing businesses.
...
Main CTAs include Book a Free Call, Book a Free Business Audit, Book an Audit, and Submit Audit Request.`
    }
  ];
